...
public class ProductController {
	...
	@Autowired
		...
		@PostMapping
		public ResponseEntity<Object> guardarP(@RequestBody ProductoDTO dto) {
			service.save(dto);
			return new ResponseEntity<>(new ApiResponseDTO<>(true, null), HttpStatus.CREATED);
		}
		
		@PutMapping(value= "/{id}")
		public ResponseEntity<Object> actualizarP(@RequestBody ProductoDTO dto) {
			service.update(dto);
			return new ResponseEntity<>(new ApiResponseDTO<>(true, null),HttpStatus.CREATED);	
		}
		
		@GetMapping
		public ResponseEntity<Object> listarP() {
		...
		@GetMapping(path = "/{id}")
		public ResponseEntity<Object> buscarP(@PathVariable Long id) {
		...
		public ResponseEntity<Object> eliminarP(@PathVariable Long id) {
			ProductoDTO dto = new ProductoDTO();
			dto.setId(id);
			Optional<Product> domain = service.find(dto);
			if (!domain.isEmpty()) {
