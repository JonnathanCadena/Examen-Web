...
public class ServiceController {
	...
	@PostMapping
	public ResponseEntity<Object> guardarS(@RequestBody ServicioDTO dto) {
		service.save(dto);
		return new ResponseEntity<>(new ApiResponseDTO<>(true, null), HttpStatus.CREATED);
	}
	
	@PutMapping(value= "/{id}")
	public ResponseEntity<Object> actualizarS(@RequestBody ServicioDTO dto) {
		service.update(dto);
		return new ResponseEntity<>(new ApiResponseDTO<>(true, null),HttpStatus.CREATED);	
	}
	
	@GetMapping
	public ResponseEntity<Object> listarS() {
	...
	@GetMapping(path = "/{id}")
	public ResponseEntity<Object> buscarS(@PathVariable Long id) {
	...
	public ResponseEntity<Object> eliminarS(@PathVariable Long id) {
		ServicioDTO dto = new ServicioDTO();
		dto.setId(id);
		Optional<Service> domain = service.find(dto);
		if (!domain.isEmpty()) {
