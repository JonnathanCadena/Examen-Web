...
public class CategoryController {
	...
	@PostMapping
	public ResponseEntity<Object> guardarC(@RequestBody CategoriaDTO dto) {
		service.save(dto);
		return new ResponseEntity<>(new ApiResponseDTO<>(true, null), HttpStatus.CREATED);
	}
	
	@PutMapping(value= "/{id}")
	public ResponseEntity<Object> actualizarC(@RequestBody CategoriaDTO dto) {
		service.update(dto);
		return new ResponseEntity<>(new ApiResponseDTO<>(true, null),HttpStatus.CREATED);	
	}
	
	@GetMapping
	public ResponseEntity<Object> listarC() {
	...
	@GetMapping(path = "/{id}")
	public ResponseEntity<Object> buscarC(@PathVariable Long id) {
	...
	public ResponseEntity<Object> eliminarC(@PathVariable Long id) {
		CategoriaDTO dto = new CategoriaDTO();
		dto.setId(id);
		Optional<Category> domain = service.find(dto);
		if (!domain.isEmpty()) {
